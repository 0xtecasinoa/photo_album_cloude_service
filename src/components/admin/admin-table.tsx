  ...
  return (
    ...
    >
      ...
      <button
        ...
        className={
          next
            ? 'grid size-9 place-items-center rounded-[6px] text-[#8EFF9F] transition-colors hover:bg-white/10'
            : 'grid size-9 place-items-center rounded-[6px] text-[#FF9C93] transition-colors hover:bg-white/10'
        }
      >
        {pending ? (
